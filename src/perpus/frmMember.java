...
public class frmMember extends javax.swing.JInternalFrame {
    ...
    public frmMember() {
        ...
        cmbJenisKelamin.addItem("Wanita");
    ...
    private boolean allowSave() {
        ...
        if (dtpJoin.getDate().toString().equals("")) {
            cls.showMsg("Tgl Bergabung harus di isi", "Simpan Gagal", 0);
            dtpJoin.grabFocus();
            return false;
        }
        if (txtNoHp.getText().equals("")) {
            cls.showMsg("No. HP harus di isi", "Simpan Gagal", 0);
            txtNoHp.grabFocus();
            return false;
        }
        if (cmbJenisKelamin.getSelectedItem().equals("")) {
            cls.showMsg("Jenis Kelamin harus di pilih", "Simpan Gagal", 0);
            cmbJenisKelamin.grabFocus();
            return false;
        }
        return true;
    }
    ...
    private void textMode(boolean bol) {
        ...
        dtpJoin.setEnabled(bol);
        cmbJenisKelamin.setEnabled(bol);
    ...
    private void initComponents() {
        ...
        dtpJoin = new org.jdesktop.swingx.JXDatePicker();
        ...
        lblTitle.setText("Master Data - Member");
        ...
        jLabel6.setText("Cari Member berdasarkan Nama Lengkap / ID Member");
        ...
        txtNoHp.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        txtNoHp.setEnabled(false);

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Tgl Gabung");

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Jenis Kelamin");

        dtpJoin.setEnabled(false);
        dtpJoin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dtpJoinActionPerformed(evt);
            }
        });
        ...
        jLabel4.setText("*Di isi dengan NIM / NIP / NIS / NISN");
                    ...
                    .addGroup(pnlFormLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(pnlFormLayout.createSequentialGroup()
                                ...
                                .addGap(15, 15, 15)
                                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(dtpJoin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cmbJenisKelamin, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(pnlFormLayout.createSequentialGroup()
                                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(pnlFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtNoHp, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(pnlFormLayout.createSequentialGroup()
                                        .addComponent(txtIDMember, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tblBukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBukuMouseClicked
        ...
        txtIDMember.setText((String)tblBuku.getValueAt(row, 0).toString());
        txtNama.setText((String)tblBuku.getValueAt(row, 1));
        txtNoHp.setText((String)tblBuku.getValueAt(row, 2));
        dtpJoin.setDate((Date)tblBuku.getValueAt(row, 3));
        String jkelamin = (String)tblBuku.getValueAt(row, 4);
        if (jkelamin.equals("Pria")) {
            cmbJenisKelamin.setSelectedIndex(1);
        }
        else {
            cmbJenisKelamin.setSelectedIndex(2);
        }
        txtIDMember.grabFocus();
        textMode(false);
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        ...
        if (!allowSave()){ return; }
        try {
            DateFormat sysFormatDate = new SimpleDateFormat("yyyy-MM-dd");
            String tgl = sysFormatDate.format(dtpJoin.getDate()).toString();
            if (txtIDMember.isEnabled()) {
                oConn.setData("insert into t_member (id_member, nama, "
                    + "no_hp, tgl_join, j_kelamin) "
                    + "values ('" + txtIDMember.getText() + "','" + txtNama.getText() + "', "
                    + "'" + txtNoHp.getText() + "', '" + tgl + "', "
                    + "'" +  cmbJenisKelamin.getSelectedItem()+ "')");
            }
            else {
                oConn.setData("update t_member set nama= '" + txtNama.getText() + "', "
                    + "no_hp = '" + txtNoHp.getText() + "', tgl_join= '" + tgl + "', "
                    + "j_kelamin = '" + cmbJenisKelamin.getSelectedItem() + "' where "
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        // TODO add your handling code here:
        if (txtIDMember.getText().equals("")) {
            cls.showMsg("Harap pilih member yang akan dihapus !", "Hapus Gagal", 2);
            txtIDMember.grabFocus();
            return;
        }
        int btn = JOptionPane.YES_NO_OPTION;
        int res=JOptionPane.showConfirmDialog(null,"Apakah anda yakin ingin "
            + "menghapus data member [" + txtIDMember.getText() + " - " +
            txtNama.getText()  + "] ?","Hapus Data",btn);
    ...
    private void dtpJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dtpJoinActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_dtpJoinActionPerformed
    ...
    private org.jdesktop.swingx.JXDatePicker dtpJoin;
